*SELECTION-SCREEN BEGIN OF BLOCK b_cust WITH FRAME TITLE TEXT-c01.
*  SELECTION-SCREEN BEGIN OF LINE.
*  PARAMETERS: p_graube LIKE rm06a-p_grupp.
*  SELECTION-SCREEN COMMENT  3(35) TEXT-s13 FOR FIELD p_graube.
